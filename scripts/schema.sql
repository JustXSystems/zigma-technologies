...
CREATE TABLE IF NOT EXISTS catalog_page_settings (
  ...
  listing_align VARCHAR(16) NOT NULL DEFAULT 'left',
  ...
  discovery_profile_rail_enabled TINYINT(1) NOT NULL DEFAULT 1,
  discovery_quick_find_enabled TINYINT(1) NOT NULL DEFAULT 1,
  discovery_facet_rail_enabled TINYINT(1) NOT NULL DEFAULT 1,
  discovery_grouped_results_enabled TINYINT(1) NOT NULL DEFAULT 1,
  discovery_sticky_toolbar_enabled TINYINT(1) NOT NULL DEFAULT 1,
  discovery_group_preview_count TINYINT UNSIGNED NOT NULL DEFAULT 4,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB;
